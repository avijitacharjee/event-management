                                                    ...
                                                    <div class="main-card">
                                                        <div class="blog-block flex-slide">
                                                            <div class="blog-img-card left">
                                                                <a href="{{ url('/blog/3') }}"
                                                                    class="bbig-img">
                                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-1.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="main-card">
                                                        <div class="blog-block flex-slide">
                                                            <div class="blog-img-card left">
                                                                <a href="{{ url('/blog/3') }}"
                                                                    class="bbig-img">
                                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-12.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="blog-content right">
                                                    ...
                                                    <div class="main-card">
                                                        <div class="blog-block flex-slide">
                                                            <div class="blog-img-card left">
                                                                <a href="{{ url('/blog/3') }}"
                                                                    class="bbig-img">
                                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-3.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="blog-content right">
                                                    ...
                                                    <div class="main-card">
                                                        <div class="blog-block flex-slide">
                                                            <div class="blog-img-card left">
                                                                <a href="{{ url('/blog/3') }}"
                                                                    class="bbig-img">
                                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-4.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                            </div>
                                                            <div class="blog-content right">
                                ...
                                <div class="row g-4">
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-1.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-2.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                                <a href="{{ url('/blog/3') }}" class="blog-title fs-16">How
                                                    to Live
                                                    Stream
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            ...
                                            <div class="blog-content">
                                                <a href="{{ url('/blog/3') }}" class="blog-title fs-16">13
                                                    Awesome
                                                    Virtual
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-5.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-6.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-7.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-8.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                                <a href="{{ url('/blog/3') }}" class="blog-title fs-16">The
                                                    Organiser’s
                                                    Guide
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-9.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                                <a href="{{ url('/blog/3') }}" class="blog-title fs-16">4
                                                    Ways How
                                                    Technology
                                                    Can Simplify Event
                                                    Ticketing</a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-10.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                                <a href="{{ url('/blog/3') }}" class="blog-title fs-16">23
                                                    Creative Event
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="main-card">
                                            <div class="blog-thumbnail">
                                                <a href="{{ url('/blog/3') }}" class="thumbnail-img">
                                                    <img src="{{ asset('/asset/barren/images/blog-imgs/img-11.jpg') }}"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="blog-content">
                                                <a href="{{ url('/blog/3') }}" class="blog-title fs-16">New
                                                    Event
                                                    Ticketing
                                                    Features: Barren
                                                    (2022)</a>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="browse-btn mt-4">
                                            <a href="{{ url('#') }}" class="main-btn btn-hover">See More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
