                                ...
                                <div class="d-flex flex-wrap justify-content-between align-items-center p-4">
                                    <div
                                        ...
                                        <div class="dashboard-date-arrows">
                                            <a href="{{ url('#') }}" class="before_date"><i
                                                    class="fa-solid fa-angle-left"></i></a>
                                            <a href="{{ url('#') }}" class="after_date disabled"><i
                                    ...
                                    <div class="rs">
                                        <div class="dropdown dropdown-text event-list-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="{{ url('#') }}">1</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="dashboard-report-card purple">
                                                <div class="card-content">
                                                    <div class="card-content">
                                                        <span class="card-title fs-6">Revenue
                                                            (AUD)</span>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="dashboard-report-card info">
                                                <div class="card-content">
                                                    <div class="card-content">
                                                        <span class="card-title fs-6">Page
                                                            Views</span>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6">
                                            <div class="dashboard-report-card success">
                                                <div class="card-content">
                                                    <div class="card-content">
                                                        <span class="card-title fs-6">Ticket
                                                            Sales</span>
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center border_bottom p-4">
                                <div
                                    ...
                                    <div class="select-graphic-category">
                                        ...
                                        <small class="mt-4">See the graphical
                                            representation below</small>
                                    </div>
                                </div>
                                <div class="rs">
