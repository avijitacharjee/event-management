                                ...
                                <div class="row" data-ref="event-filter-content">
                                        ...
                                        <div class="main-card mt-4">
                                            <div class="event-thumbnail">
                                                <a href="venue_event_detail_view.html" class="thumbnail-img">
                                                    <img src="{{ asset('asset/barren/images/event-imgs/img-1.jpg') }}""
                                                        alt="">
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mix coaching_consulting free concert volunteer health_Wellness bussiness"
                                        ...
                                        <div class="main-card mt-4">
                                            <div class="event-thumbnail">
                                                <a href="venue_event_detail_view.html" class="thumbnail-img">
                                                    <img src="{{ asset('asset/barren/images/event-imgs/img-3.jpg') }}""
                                                        alt="">
                                                </a>
                                                <span class="bookmark-icon" title="Bookmark"></span>
                                            </div>
                                    ...
                                    <div class=" col-xl-3 col-lg-4 col-md-6 col-sm-12 mix health_Wellness concert volunteer sports free business"
                                        ...
                                        <div class="main-card mt-4">
                                            <div class="event-thumbnail">
                                                <a href="online_event_detail_view.html" class="thumbnail-img">
                                                    <img src="{{ asset('asset/barren/images/event-imgs/img-4.jpg') }}""
                                                        alt="">
                                                </a>
                                                <span class="bookmark-icon" title="Bookmark"></span>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mix concert sports health_Wellness free arts"
                                        ...
                                        <div class="main-card mt-4">
                                            <div class="event-thumbnail">
                                                <a href="venue_event_detail_view.html" class="thumbnail-img">
                                                    <img src="{{ asset('asset/barren/images/event-imgs/img-5.jpg') }}""
                                                        alt="">
                                                </a>
                                                <span class="bookmark-icon" title="Bookmark"></span>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mix workshops concert arts volunteer sports"
                                        ...
                                        <div class="main-card mt-4">
                                            <div class="event-thumbnail">
                                                <a href="venue_event_detail_view.html" class="thumbnail-img">
                                                    <img src="{{ asset('asset/barren/images/event-imgs/img-6.jpg') }}""
                                                        alt="">
                                                </a>
                                                <span class="bookmark-icon" title="Bookmark"></span>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 mix sports concert volunteer arts"
                                        ...
                                        <div class="main-card mt-4">
                                            <div class="event-thumbnail">
                                                <a href="venue_event_detail_view.html" class="thumbnail-img">
                                                    <img src="{{ asset('asset/barren/images/event-imgs/img-8.jpg') }}""
                                                        alt="">
                                                </a>
                                                <span class="bookmark-icon" title="Bookmark"></span>
                                            </div>
                            ...
                            <div class="owl-carousel engaging-slider owl-theme">
                                <div class="item">
                                    <div class="main-card">
                                        <div class="host-item">
                                            <div class="host-img">
                                                <img src="{{ asset('asset/barren/images/icons/venue-events.png') }}"
                                                    alt="">
                                            </div>
                                            <h4>Venue Events</h4>
                                ...
                                <div class="item">
                                    <div class="main-card">
                                        <div class="host-item">
                                            <div class="host-img">
                                                <img src="{{ asset('asset/barren/images/icons/webinar.png') }}"
                                                    alt="">
                                            </div>
                                            <h4>Webinar</h4>
                                ...
                                <div class="item">
                                    <div class="main-card">
                                        <div class="host-item">
                                            <div class="host-img">
                                                <img src="{{ asset('asset/barren/images/icons/training-workshop.png') }}"
                                                    alt="">
                                            </div>
                                ...
                                <div class="item">
                                    <div class="main-card">
                                        <div class="host-item">
                                            <div class="host-img">
                                                <img src="{{ asset('asset/barren/images/icons/online-class.png') }}"
                                                    alt="">
                                            </div>
                                            <h4>Online Class</h4>
                                ...
                                <div class="item">
                                    <div class="main-card">
                                        <div class="host-item">
                                            <div class="host-img">
                                                <img src="{{ asset('asset/barren/images/icons/talk-show.png') }}"
                                                    alt="">
                                            </div>
                                            <h4>Talk Show</h4>
                        ...
                        <div class="feature-group-list">
                            <div class="row">
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-1.png') }}"
                                                alt="">
                                        </div>
                                        <h4>Online Events</h4>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-2.png') }}"
                                                alt="">
                                        </div>
                                        <h4>Venue Event</h4>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-3.png') }}"
                                                alt="">
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-4.png') }}"
                                                alt="">
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-5.png') }}"
                                                alt="">
                                        </div>
                                        <h4>Sell Tickets</h4>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-6.png') }}"
                                                alt="">
                                        </div>
                                        <h4>Networking</h4>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-7.png') }}"
                                                alt="">
                                        </div>
                                        <h4>Recording</h4>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-8.png') }}"
                                                alt="">
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-9.png') }}"
                                                alt="">
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-10.png') }}"
                                                alt="">
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-11.png') }}"
                                                alt="">
                                        </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="feature-item mt-46">
                                        <div class="feature-icon">
                                            <img src="{{ asset('asset/barren/images/icons/feature-icon-12.png') }}"
                                                alt="">
                                        </div>
                                ...
                                <div class="tab-pane fade show active" id="step-01" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-1.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-2.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-3.png') }}"
                                                        alt="">
                                                </div>
                                ...
                                <div class="tab-pane fade" id="step-02" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-4.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-5.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-6.png') }}"
                                                        alt="">
                                                </div>
                                ...
                                <div class="tab-pane fade" id="step-03" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-7.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-8.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-9.png') }}"
                                                        alt="">
                                                </div>
                                ...
                                <div class="tab-pane fade" id="step-04" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-10.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-11.png') }}"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="step-item">
                                                <div class="step-icon">
                                                    <img src="{{ asset('asset/barren/images/icons/step-icon-12.png') }}"
                                                        alt="">
                                                </div>
