...
@section('content')
    <x-modals.edit-profile-modal/>
    <x-modals.followers-modal/>
    <div class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-12">
                            <div class="main-card user-left-dt">
                                ...
                                <div class="user-dts">
                                    <h4 class="user-name">
                                        {{$user->name}}<span class="verify-badge"><i class="fa-solid fa-circle-check"></i></span>
                                    </h4>
                                    <span class="user-email">{{$user->email}}</span>
                                </div>
                                <div class="ff-block">
                                    <a href="{{ url('#') }}" class="" role="button" data-bs-toggle="modal"
                                        data-bs-target="#FFModal"><span>0</span>Followers</a>
                                    <a href="{{ url('#') }}" class="" role="button" data-bs-toggle="modal"
                                        data-bs-target="#FFModal"><span>2</span>Following</a>
                                </div>
                                <div class="user-description">
                                    <p>Hey I am a {{$user->name}}</p>
                                </div>
                                <div class="user-btns">
                                    ...
                                    <ul class="nav nav-pills nav-fill p-2 garren-line-tab" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="feed-tab" data-bs-toggle="tab"
                                                href="{{ url('#feed') }}" role="tab" aria-controls="feed"
                                                aria-selected="true"><i class="fa-solid fa-house"></i>Home</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="about-tab" data-bs-toggle="tab"
                                                href="{{ url('#about') }}" role="tab" aria-controls="about"
                                                aria-selected="false"><i class="fa-solid fa-circle-info"></i>About</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="setting-tab" data-bs-toggle="tab"
                                                href="{{ url('#setting') }}" role="tab" aria-controls="setting"
                                                aria-selected="false"><i class="fa-solid fa-gear"></i>Setting</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="orders-tab" data-bs-toggle="tab"
                                                href="{{ url('#orders') }}" role="tab" aria-controls="orders"
                                                aria-selected="false"><i class="fa-solid fa-box"></i>My Orders</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="tab-pane fade active show" id="feed" role="tabpanel"
                                            ...
                                            <div class="nav my-event-tabs mt-4" role="tablist">
                                                <button class="event-link active" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="saved" aria-selected="true">
                                                ...
                                                <button class="event-link" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="organised" aria-selected="false">
                                                    <span class="event-count">2</span><span>Organised
                                                        Events</span>
                                                </button>
                                                <button class="event-link" data-bs-toggle="tab"
                                                    data-bs-target="#attending" type="button" role="tab"
                                                    aria-controls="attending" aria-selected="false">
                                                    <span class="event-count">1</span><span>Attending
                                                        Events</span>
                                                </button>
                                            </div>
                                            ...
                                            <div class="main-card mt-4">
                                                ...
                                                <div class="card-bottom">
                                                    ...
                                                    <div class="card-bottom-item">
                                                        ...
                                                        <div class="card-dt-text">
                                                            <h6>Invoice</h6>
                                                            <a href="{{ url('invoice.html') }}">Download</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
